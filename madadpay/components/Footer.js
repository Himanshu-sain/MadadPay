    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center mb-4">
              <Image 
                ...
                className="mr-2"
              />
              <span className="text-xl font-bold text-blue-400">CashLoop</span>
            </div>
            <p className="text-gray-400 text-sm">
              The safe and easy way to exchange cash and online funds with people near you.
            </p>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/exchange/create" className="text-gray-400 hover:text-white transition-colors">
                  Create Exchange
                </Link>
              </li>
            </ul>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/help#contact" className="text-gray-400 hover:text-white transition-colors">
                  Contact Us
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400 text-sm">
            &copy; {new Date().getFullYear()} CashLoop. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
